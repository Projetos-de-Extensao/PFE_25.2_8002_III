...
export const mockVagas = [
  ...
  },
  {
    ...
    curso: 'Engenharia',
    professor: 'Prof. Roberto Andrade',
  ...
  {
    id: 'v6',
    titulo: 'Monitor de Cálculo II',
    curso: 'Engenharia',
    professor: 'Prof. Roberto Andrade',
    descricao: 'Plantões focados em séries, integrais múltiplas e aplicações avançadas para apoiar notas finais.',
    tags: ['Cálculo', 'Séries', 'Integrais Múltiplas']
  }
]
...
export const mockApplications = [
  ...
  { id: 'a2', vagaId: 'v2', vaga: 'Monitor de Banco de Dados', status: 'Aceito', professor: 'Profa. Almeida', studentId: 'dev_aluno', studentName: 'Aluno Demo', studentEmail: 'aluno@aluno.ibmec.edu.br' },
  ...
  { id: 'a5', vagaId: 'v5', vaga: 'Monitor de Cálculo I', status: 'Em Análise', professor: 'Prof. Roberto Andrade', studentId: 'u4', studentName: 'Ana Costa', studentEmail: 'ana.costa@example.com' },
  { id: 'a6', vagaId: 'v6', vaga: 'Monitor de Cálculo II', status: 'Em Análise', professor: 'Prof. Roberto Andrade', studentId: 'u6', studentName: 'Lucia Ferreira', studentEmail: 'lucia.ferreira@example.com' }
]
...
export const mockApplicants = [
  ...
  { id: 'ap6', vagaId: 'v5', nome: 'Larissa Mendes', curso: 'Engenharia', email: 'larissa.mendes@example.com', grade: 8.9, descricao: 'Atuei como monitora informal em cálculo I (derivadas).', selected: false, relatorio: '' },
  { id: 'ap7', vagaId: 'v6', nome: 'Paulo Ribeiro', curso: 'Engenharia', email: 'paulo.ribeiro@example.com', grade: 8.3, descricao: 'Tenho facilidade com integrais múltiplas e quero apoiar meus colegas.', selected: false, relatorio: '' }
]
